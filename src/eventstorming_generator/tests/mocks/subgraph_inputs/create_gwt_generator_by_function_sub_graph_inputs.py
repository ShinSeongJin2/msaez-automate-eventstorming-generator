from ....models import State, InputsModel, OutputsModel, UserInfoModel, InformationModel, EsValueModel, SubgraphsModel, CreateAggregateByFunctionsModel, CreateAggregateClassIdByDraftsModel, CreateCommandActionsByFunctionModel, CreatePolicyActionsByFunctionModel, CreateGwtGeneratorByFunctionModel, LLMModel

create_gwt_generator_by_function_sub_graph_inputs = State(
    inputs=InputsModel(
...
#            model_max_input_limit=7520
    ...
    subgraphs=SubgraphsModel(
        ...
        createGwtGeneratorByFunctionModel=CreateGwtGeneratorByFunctionModel()
    ),
    outputs=OutputsModel(
        esValue=EsValueModel(
            elements={
                ...
                "b38d6c5b-314b-4374-bdf7-1157838150b5": {
                    "id": "b38d6c5b-314b-4374-bdf7-1157838150b5",
                    "author": "My-UID",
                    "boundedContext": {
                        "id": "c517babe-52fb-48ba-8920-60df60b3da1e"
                    },
                    "description": "도서 상태가 변경될 때마다 상태 변경 이력을 남겨야 관리자가 도서의 상태 변화를 추적할 수 있습니다.",
                    "elementView": {
                        "height": 115,
                        "width": 100,
                        "x": 1452.0,
                    ...
                    "isSaga": False,
                    "name": "BookStatusHistoryRecordingPolicy",
                    "displayName": "도서 상태 변경 이력 자동 기록",
                    "nameCamelCase": "bookStatusHistoryRecordingPolicy",
                    "namePascalCase": "BookStatusHistoryRecordingPolicy",
                    "namePlural": "bookStatusHistoryRecordingPolicies",
                    "oldName": "",
                    "rotateStatus": False,
                    "_type": "org.uengine.modeling.model.Policy"
                },
                "389e54a8-c15e-4be1-b52a-6c67db621423": {
                    "id": "389e54a8-c15e-4be1-b52a-6c67db621423",
                    "author": "My-UID",
                    "boundedContext": {
                        "id": "c517babe-52fb-48ba-8920-60df60b3da1e"
                    },
                    "description": "도서 대출, 반납, 연장, 연체 등 이벤트 발생 시 대출 이력을 자동으로 기록하여 도서별 이력 조회 및 관리가 용이하도록 합니다.",
                    "elementView": {
                        "height": 115,
                        "width": 100,
                        "x": 1022.0,
                    ...
                    "isSaga": False,
                    "name": "LoanHistoryRecordingPolicy",
                    "displayName": "대출/반납/연장/연체 이력 자동 기록",
                    "nameCamelCase": "loanHistoryRecordingPolicy",
                    "namePascalCase": "LoanHistoryRecordingPolicy",
                    "namePlural": "loanHistoryRecordingPolicies",
                    "oldName": "",
                    "rotateStatus": False,
                    "_type": "org.uengine.modeling.model.Policy"
                }
            ...
            relations={
                ...
                "053d8451-a73a-42f8-b606-f0dd6e9e7d6a": {
                    "_type": "org.uengine.modeling.model.Relation",
                    "name": "",
                    "id": "053d8451-a73a-42f8-b606-f0dd6e9e7d6a",
                    "sourceElement": {
                        "alertURL": "/static/image/symbol/alert-icon.png",
                        "author": "My-UID",
                        "checkAlert": True,
                    ...
                    "from": "dce353ac-1c01-437d-846a-e541170d2317",
                    "to": "b38d6c5b-314b-4374-bdf7-1157838150b5",
                    "relationView": {
                        "id": "053d8451-a73a-42f8-b606-f0dd6e9e7d6a",
                        "style": "{\"arrow-start\":\"none\",\"arrow-end\":\"none\"}",
                        "from": "dce353ac-1c01-437d-846a-e541170d2317",
                ...
                "ccff8c17-d8b8-4f94-8870-dc09a0cf03b8": {
                    "_type": "org.uengine.modeling.model.Relation",
                    "name": "",
                    "id": "ccff8c17-d8b8-4f94-8870-dc09a0cf03b8",
                    "sourceElement": {
                        "id": "b38d6c5b-314b-4374-bdf7-1157838150b5",
                        "author": "My-UID",
                        "boundedContext": {
                    ...
                    "from": "b38d6c5b-314b-4374-bdf7-1157838150b5",
                    "to": "00dbfc77-0e4a-4dc9-b132-23d4b5f5767c",
                    "relationView": {
                        "id": "ccff8c17-d8b8-4f94-8870-dc09a0cf03b8",
                        "style": "{\"arrow-start\":\"none\",\"arrow-end\":\"none\"}",
                        "from": "b38d6c5b-314b-4374-bdf7-1157838150b5",
                ...
                "3b223de9-f5ea-4e93-94ee-5aa14bb1e411": {
                    "_type": "org.uengine.modeling.model.Relation",
                    "name": "",
                    "id": "3b223de9-f5ea-4e93-94ee-5aa14bb1e411",
                    "sourceElement": {
                        "alertURL": "/static/image/symbol/alert-icon.png",
                        "author": "My-UID",
                        "checkAlert": True,
                    ...
                    "from": "dce353ac-1c01-437d-846a-e541170d2317",
                    "to": "389e54a8-c15e-4be1-b52a-6c67db621423",
                    "relationView": {
                        "id": "3b223de9-f5ea-4e93-94ee-5aa14bb1e411",
                        "style": "{\"arrow-start\":\"none\",\"arrow-end\":\"none\"}",
                        "from": "dce353ac-1c01-437d-846a-e541170d2317",
                ...
                "62b4eea5-72f7-4205-b6f4-09e423ffd44b": {
                    "_type": "org.uengine.modeling.model.Relation",
                    "name": "",
                    "id": "62b4eea5-72f7-4205-b6f4-09e423ffd44b",
                    "sourceElement": {
                        "id": "389e54a8-c15e-4be1-b52a-6c67db621423",
                        "author": "My-UID",
                        "boundedContext": {
                    ...
                    "from": "389e54a8-c15e-4be1-b52a-6c67db621423",
                    "to": "3b804b8b-3b73-46b6-b8d0-a8892db6c0f2",
                    "relationView": {
                        "id": "62b4eea5-72f7-4205-b6f4-09e423ffd44b",
                        "style": "{\"arrow-start\":\"none\",\"arrow-end\":\"none\"}",
                        "from": "389e54a8-c15e-4be1-b52a-6c67db621423",
