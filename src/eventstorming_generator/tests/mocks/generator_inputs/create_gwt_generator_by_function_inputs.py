create_gwt_generator_by_function_inputs = {
    ...
    "esValue": {
        "elements": {
            ...
            "7d40fe80-479c-915e-924b-17d173b14eb8": {
                "id": "7d40fe80-479c-915e-924b-17d173b14eb8",
                "author": "EYCl46CwWAWvpz2E1BCUpVgPIpa2",
                "boundedContext": {
                    "id": "97f2473e-7068-21ee-652d-ba0a8f41dd2c"
                },
                "description": "도서가 대출되면 도서 상태를 '대출중'으로 자동 전환하여 실제 대출 가능 여부를 시스템에 반영하기 위함입니다.",
                "elementView": {
                    "height": 116,
                    "width": 100,
                    "x": 437,
                ...
                "isSaga": False,
                "name": "LoanStatusUpdatePolicy",
                "displayName": "도서 대출 시 상태 변경",
                "nameCamelCase": "loanStatusUpdatePolicy",
                "namePascalCase": "LoanStatusUpdatePolicy",
                "namePlural": "loanStatusUpdatePolicies",
                "oldName": "",
                "rotateStatus": False,
                "_type": "org.uengine.modeling.model.Policy"
            },
            "cfabd85c-4337-46de-6e7f-c7c14fe90da1": {
                "id": "cfabd85c-4337-46de-6e7f-c7c14fe90da1",
                "author": "EYCl46CwWAWvpz2E1BCUpVgPIpa2",
                "boundedContext": {
                    "id": "97f2473e-7068-21ee-652d-ba0a8f41dd2c"
                },
                "description": "도서가 반납되면 도서 상태를 '대출가능'으로 복구하여 다른 사용자가 즉시 대출할 수 있도록 합니다.",
                "elementView": {
                    "height": 116,
                    "width": 100,
                    "x": 437,
                ...
                "isSaga": False,
                "name": "ReturnStatusUpdatePolicy",
                "displayName": "도서 반납 시 상태 변경",
                "nameCamelCase": "returnStatusUpdatePolicy",
                "namePascalCase": "ReturnStatusUpdatePolicy",
                "namePlural": "returnStatusUpdatePolicies",
                "oldName": "",
                "rotateStatus": False,
                "_type": "org.uengine.modeling.model.Policy"
            },
            "b6bbeb13-6265-74c6-8e3a-fbf1bbe3c020": {
                "id": "b6bbeb13-6265-74c6-8e3a-fbf1bbe3c020",
                "author": "EYCl46CwWAWvpz2E1BCUpVgPIpa2",
                "boundedContext": {
                    "id": "97f2473e-7068-21ee-652d-ba0a8f41dd2c"
                },
                "description": "도서가 예약될 경우, 상태를 '예약중'으로 자동 전환하여 대출 및 반납 프로세스에 혼선을 방지합니다.",
                "elementView": {
                    "height": 116,
                    "width": 100,
                    "x": 437,
                ...
                "isSaga": False,
                "name": "ReserveStatusUpdatePolicy",
                "displayName": "도서 예약 시 상태 변경",
                "nameCamelCase": "reserveStatusUpdatePolicy",
                "namePascalCase": "ReserveStatusUpdatePolicy",
                "namePlural": "reserveStatusUpdatePolicies",
                "oldName": "",
                "rotateStatus": False,
                "_type": "org.uengine.modeling.model.Policy"
            },
            "79973ab8-722f-692b-4dd8-71e2402202f1": {
                "id": "79973ab8-722f-692b-4dd8-71e2402202f1",
                "author": "EYCl46CwWAWvpz2E1BCUpVgPIpa2",
                "boundedContext": {
                    "id": "4fc9eb9f-f332-e3e6-43d3-0bb9f1b16908"
                },
                "description": "도서가 폐기 처리되면, 더 이상 대출이 불가하므로 대출 관리 시스템에서 해당 도서를 제외하도록 처리합니다.",
                "elementView": {
                    "height": 116,
                    "width": 100,
                    "x": 1022,
                ...
                "isSaga": False,
                "name": "BookDiscardBlockLoanPolicy",
                "displayName": "도서 폐기 시 대출 차단",
                "nameCamelCase": "bookDiscardBlockLoanPolicy",
                "namePascalCase": "BookDiscardBlockLoanPolicy",
                "namePlural": "bookDiscardBlockLoanPolicies",
                "oldName": "",
                "rotateStatus": False,
                "_type": "org.uengine.modeling.model.Policy"
            }
        ...
        "relations": {
            ...
            "c1bf4db0-8e31-2a72-f50b-ac0fbb096eff": {
                "_type": "org.uengine.modeling.model.Relation",
                "name": "",
                "id": "c1bf4db0-8e31-2a72-f50b-ac0fbb096eff",
                "sourceElement": {
                    "alertURL": "/static/image/symbol/alert-icon.png",
                    "author": "EYCl46CwWAWvpz2E1BCUpVgPIpa2",
                    "checkAlert": True,
                ...
                "from": "b12ad8fd-6404-c544-5ff8-b5bc1fdcae20",
                "to": "7d40fe80-479c-915e-924b-17d173b14eb8",
                "relationView": {
                    "id": "c1bf4db0-8e31-2a72-f50b-ac0fbb096eff",
                    "style": "{\"arrow-start\":\"none\",\"arrow-end\":\"none\"}",
                    "from": "b12ad8fd-6404-c544-5ff8-b5bc1fdcae20",
            ...
            "3bc819e8-2670-fe4d-d379-b785f8d8096e": {
                "_type": "org.uengine.modeling.model.Relation",
                "name": "",
                "id": "3bc819e8-2670-fe4d-d379-b785f8d8096e",
                "sourceElement": {
                    "id": "7d40fe80-479c-915e-924b-17d173b14eb8",
                    "author": "EYCl46CwWAWvpz2E1BCUpVgPIpa2",
                    "boundedContext": {
                ...
                "from": "7d40fe80-479c-915e-924b-17d173b14eb8",
                "to": "279c5170-159b-2b0d-34fa-e2e42dd5e0a9",
                "relationView": {
                    "id": "3bc819e8-2670-fe4d-d379-b785f8d8096e",
                    "style": "{\"arrow-start\":\"none\",\"arrow-end\":\"none\"}",
                    "from": "7d40fe80-479c-915e-924b-17d173b14eb8",
            ...
            "8b762ce5-d517-9bf9-6c80-0389d762ec70": {
                "_type": "org.uengine.modeling.model.Relation",
                "name": "",
                "id": "8b762ce5-d517-9bf9-6c80-0389d762ec70",
                "sourceElement": {
                    "alertURL": "/static/image/symbol/alert-icon.png",
                    "author": "EYCl46CwWAWvpz2E1BCUpVgPIpa2",
                    "checkAlert": True,
                ...
                "from": "7134ee93-d752-ba68-bcd8-c39788567f0f",
                "to": "cfabd85c-4337-46de-6e7f-c7c14fe90da1",
                "relationView": {
                    "id": "8b762ce5-d517-9bf9-6c80-0389d762ec70",
                    "style": "{\"arrow-start\":\"none\",\"arrow-end\":\"none\"}",
                    "from": "7134ee93-d752-ba68-bcd8-c39788567f0f",
            ...
            "e9f9383d-ffc1-f33d-695c-e0d999975c05": {
                "_type": "org.uengine.modeling.model.Relation",
                "name": "",
                "id": "e9f9383d-ffc1-f33d-695c-e0d999975c05",
                "sourceElement": {
                    "id": "cfabd85c-4337-46de-6e7f-c7c14fe90da1",
                    "author": "EYCl46CwWAWvpz2E1BCUpVgPIpa2",
                    "boundedContext": {
                ...
                "from": "cfabd85c-4337-46de-6e7f-c7c14fe90da1",
                "to": "279c5170-159b-2b0d-34fa-e2e42dd5e0a9",
                "relationView": {
                    "id": "e9f9383d-ffc1-f33d-695c-e0d999975c05",
                    "style": "{\"arrow-start\":\"none\",\"arrow-end\":\"none\"}",
            ...
            "fbcfbab2-826c-2778-54ca-a594caa074df": {
                "_type": "org.uengine.modeling.model.Relation",
                "name": "",
                "id": "fbcfbab2-826c-2778-54ca-a594caa074df",
                "sourceElement": {
                    "alertURL": "/static/image/symbol/alert-icon.png",
                    "author": "EYCl46CwWAWvpz2E1BCUpVgPIpa2",
                    "checkAlert": True,
                ...
                "relationView": {
                    "id": "fbcfbab2-826c-2778-54ca-a594caa074df",
                    "style": "{\"arrow-start\":\"none\",\"arrow-end\":\"none\"}",
                    "from": "e5cb69a8-8001-cf81-d4da-fffd1401afe5",
                    "to": "b6bbeb13-6265-74c6-8e3a-fbf1bbe3c020",
                    "needReconnect": True,
                    "value": "[[0,0],[70,0]]"
                },
                "hexagonalView": {
            ...
            "ed4246f7-c154-9f39-84aa-23d4408f18b0": {
                "_type": "org.uengine.modeling.model.Relation",
                "name": "",
                "id": "ed4246f7-c154-9f39-84aa-23d4408f18b0",
                "sourceElement": {
                    "id": "b6bbeb13-6265-74c6-8e3a-fbf1bbe3c020",
                    "author": "EYCl46CwWAWvpz2E1BCUpVgPIpa2",
                    "boundedContext": {
                ...
                "from": "b6bbeb13-6265-74c6-8e3a-fbf1bbe3c020",
                "to": "279c5170-159b-2b0d-34fa-e2e42dd5e0a9",
                "relationView": {
                    "id": "ed4246f7-c154-9f39-84aa-23d4408f18b0",
                    "style": "{\"arrow-start\":\"none\",\"arrow-end\":\"none\"}",
            ...
            "e3893290-e785-5daa-742a-1a40c1762c2f": {
                "_type": "org.uengine.modeling.model.Relation",
                "name": "",
                "id": "e3893290-e785-5daa-742a-1a40c1762c2f",
                "sourceElement": {
                    "alertURL": "/static/image/symbol/alert-icon.png",
                    "author": "EYCl46CwWAWvpz2E1BCUpVgPIpa2",
                    "checkAlert": True,
                ...
                "from": "bdad54b2-d2ba-9e60-f28e-4959a9d55f42",
                "to": "79973ab8-722f-692b-4dd8-71e2402202f1",
                "relationView": {
                    "id": "e3893290-e785-5daa-742a-1a40c1762c2f",
                    "style": "{\"arrow-start\":\"none\",\"arrow-end\":\"none\"}",
                    "from": "bdad54b2-d2ba-9e60-f28e-4959a9d55f42",
                    "to": "79973ab8-722f-692b-4dd8-71e2402202f1",
                    "needReconnect": True,
                    "value": "[[794,512],[884,512],[884,380],[972,380]]"
                },
                "hexagonalView": {
                    "_type": "org.uengine.modeling.model.RelationHexagonal",
                    "from": "bdad54b2-d2ba-9e60-f28e-4959a9d55f42",
            ...
            "b3a4380f-2302-4bbd-3a97-d30250ed42d7": {
                "_type": "org.uengine.modeling.model.Relation",
                "name": "",
                "id": "b3a4380f-2302-4bbd-3a97-d30250ed42d7",
                "sourceElement": {
                    "id": "79973ab8-722f-692b-4dd8-71e2402202f1",
                    "author": "EYCl46CwWAWvpz2E1BCUpVgPIpa2",
                    "boundedContext": {
                ...
                "from": "79973ab8-722f-692b-4dd8-71e2402202f1",
                "to": "621d4bda-16fd-1bda-d837-89991959fbb2",
                "relationView": {
                    "id": "b3a4380f-2302-4bbd-3a97-d30250ed42d7",
                    "style": "{\"arrow-start\":\"none\",\"arrow-end\":\"none\"}",
                    "from": "79973ab8-722f-692b-4dd8-71e2402202f1",
    ...
    "esAliasTransManager": {
        ...
        "UUIDToAliasDic": {
            ...
            "14f9b8d9-e377-cec8-c1b5-45cd402bfad7": "act-사용자-2",
            "c4db0e92-3b28-e623-3a23-a8403a3ddff7": "act-사용자-3",
            "5a6c7a17-38f7-5f5a-23c5-11c2dd454202": "act-사용자-4",
            ...
            "4eee8a0f-e72d-24b4-ae8f-e2493a1da402": "act-사용자-5",
            "1a0d724e-ff36-0fe6-4887-b34b87958b31": "act-사용자-6",
            "d889f16d-4519-6b8a-7e56-f1dd4141235c": "act-사용자-7",
            "76c5c940-5d8a-b57e-9c93-49ded3868763": "act-사용자-8",
            "7d40fe80-479c-915e-924b-17d173b14eb8": "pol-loanStatusUpdatePolicy",
            "cfabd85c-4337-46de-6e7f-c7c14fe90da1": "pol-returnStatusUpdatePolicy",
            "b6bbeb13-6265-74c6-8e3a-fbf1bbe3c020": "pol-reserveStatusUpdatePolicy",
            "79973ab8-722f-692b-4dd8-71e2402202f1": "pol-bookDiscardBlockLoanPolicy",
            ...
            "c1bf4db0-8e31-2a72-f50b-ac0fbb096eff": "evt-loaned-to-pol-loanStatusUpdatePolicy",
            "3bc819e8-2670-fe4d-d379-b785f8d8096e": "pol-loanStatusUpdatePolicy-to-cmd-changeBookStatus",
            "8b762ce5-d517-9bf9-6c80-0389d762ec70": "evt-returned-to-pol-returnStatusUpdatePolicy",
            "e9f9383d-ffc1-f33d-695c-e0d999975c05": "pol-returnStatusUpdatePolicy-to-cmd-changeBookStatus",
            "fbcfbab2-826c-2778-54ca-a594caa074df": "evt-reserved-to-pol-reserveStatusUpdatePolicy",
            "ed4246f7-c154-9f39-84aa-23d4408f18b0": "pol-reserveStatusUpdatePolicy-to-cmd-changeBookStatus",
            "e3893290-e785-5daa-742a-1a40c1762c2f": "evt-bookDiscarded-to-pol-bookDiscardBlockLoanPolicy",
            "b3a4380f-2302-4bbd-3a97-d30250ed42d7": "pol-bookDiscardBlockLoanPolicy-to-cmd-returnBook"
        },
        "aliasToUUIDDic": {
            ...
            "act-사용자-2": "14f9b8d9-e377-cec8-c1b5-45cd402bfad7",
            "act-사용자-3": "c4db0e92-3b28-e623-3a23-a8403a3ddff7",
            "act-사용자-4": "5a6c7a17-38f7-5f5a-23c5-11c2dd454202",
            ...
            "act-사용자-5": "4eee8a0f-e72d-24b4-ae8f-e2493a1da402",
            "act-사용자-6": "1a0d724e-ff36-0fe6-4887-b34b87958b31",
            "act-사용자-7": "d889f16d-4519-6b8a-7e56-f1dd4141235c",
            "act-사용자-8": "76c5c940-5d8a-b57e-9c93-49ded3868763",
            "pol-loanStatusUpdatePolicy": "7d40fe80-479c-915e-924b-17d173b14eb8",
            "pol-returnStatusUpdatePolicy": "cfabd85c-4337-46de-6e7f-c7c14fe90da1",
            "pol-reserveStatusUpdatePolicy": "b6bbeb13-6265-74c6-8e3a-fbf1bbe3c020",
            "pol-bookDiscardBlockLoanPolicy": "79973ab8-722f-692b-4dd8-71e2402202f1",
            ...
            "evt-loaned-to-pol-loanStatusUpdatePolicy": "c1bf4db0-8e31-2a72-f50b-ac0fbb096eff",
            "pol-loanStatusUpdatePolicy-to-cmd-changeBookStatus": "3bc819e8-2670-fe4d-d379-b785f8d8096e",
            "evt-returned-to-pol-returnStatusUpdatePolicy": "8b762ce5-d517-9bf9-6c80-0389d762ec70",
            "pol-returnStatusUpdatePolicy-to-cmd-changeBookStatus": "e9f9383d-ffc1-f33d-695c-e0d999975c05",
            "evt-reserved-to-pol-reserveStatusUpdatePolicy": "fbcfbab2-826c-2778-54ca-a594caa074df",
            "pol-reserveStatusUpdatePolicy-to-cmd-changeBookStatus": "ed4246f7-c154-9f39-84aa-23d4408f18b0",
            "evt-bookDiscarded-to-pol-bookDiscardBlockLoanPolicy": "e3893290-e785-5daa-742a-1a40c1762c2f",
            "pol-bookDiscardBlockLoanPolicy-to-cmd-returnBook": "b3a4380f-2302-4bbd-3a97-d30250ed42d7"
        }
    },
    "targetCommandAliases": [
        "cmd-registerBook",
        "cmd-changeBookStatus",
        "cmd-discardBook"
    ],
                                ...
                                "outputCommands": [
                                    {
                                        "id": "cmd-returnBook",
                                        "name": "ReturnBook",
                                        "policyId": "pol-bookDiscardBlockLoanPolicy",
                                        "policyName": "BookDiscardBlockLoanPolicy"
                                    }
                                ]
                            }
                        ],
    ...
    "subjectText": "Creating GWTs for 도서 Aggregates"
}