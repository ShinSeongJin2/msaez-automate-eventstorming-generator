...
test_commands = {
    ...
    "test_aggregate_worker_subgraph": test_aggregate_worker_subgraph,
    ...
    "test_class_id_worker_subgraph": test_class_id_worker_subgraph,
    "test_create_element_names_by_draft_sub_graph": test_create_element_names_by_draft_sub_graph,
    "test_create_element_names_by_drafts": test_create_element_names_by_drafts,
    ...
    "test_command_actions_worker_subgraph": test_command_actions_worker_subgraph,
    ...
    "test_policy_actions_worker_subgraph": test_policy_actions_worker_subgraph,
