...
def run_es_value_creation_with_actions_collection():
    run_name = "run_es_value_creation_with_actions_collection"
    ...
    try:
        ...
        RunUtil.save_es_summarize_result_to_temp_file(result, run_name)
...
def run_es_value_creation_with_total_actions():
    run_name = "run_es_value_creation_with_total_actions"
...
def run_es_value_creation_with_mocked_actions():
    run_name = "run_es_value_creation_with_mocked_actions"
