...
Traceability Rules:
8. For every created element (Aggregate, ValueObject, Enumeration) and each of their properties, you MUST provide a `sourceReferences`.
9. The `sourceReferences` links the generated element back to the specific text in the "Functional Requirements" it was derived from. The requirements will have line numbers prepended to each line (e.g., "1: ...", "2: ...").
10. The format for `sourceReferences` is an array of Position Arrays: `[[[<start_line_number>, "<start_word_combination>"], [<end_line_number>, "<end_word_combination>"]]]`.
11. The "word_combination" MUST be a direct quote of 2-3 consecutive words from the specified line in the "Functional Requirements" to ensure it can be uniquely located. Avoid using single, common words. For example, instead of just "course", use "create a course".
12. If an element is inferred from multiple places, you can add multiple Position Arrays to the list. Example: `[[[10, "provide a title"], [10, "and price"]], [[25, "TABLE courses"], [26, "title VARCHAR"]]]`
...
25. For each generated element and its properties, determine the `sourceReferences` by finding the exact line and word combination in the functional requirements that justifies its creation. This reference must be precise and verifiable.
"""
                ...
                "aggregateActions": [
                    {
                        ...
                        "args": {
                            ...
                            "sourceReferences": [[["4", "lifecycle of a course"], ["4", "of a course"]]],
                            "properties": [
                                { "name": "courseId", "type": "Long", "isKey": True, "sourceReferences": [[["20", "course_id BIGINT"], ["20", "PRIMARY KEY"]]] },
                                { "name": "title", "sourceReferences": [[["7", "provide a title"], ["7", "a title"]]] },
                                { "name": "description", "type": "String", "sourceReferences": [[["7", "title, description"], ["7", "description, and price"]]] },
                                { "name": "instructorId", "type": "Long", "sourceReferences": [[["23", "instructor_id BIGINT"], ["23", "instructor_id BIGINT NOT NULL"]]] },
                                { "name": "price", "type": "CoursePrice", "sourceReferences": [[["7", "description, and price"], ["7", "and price"]]] },
                                { "name": "status", "type": "CourseStatus", "sourceReferences": [[["4", "and status changes"], ["4", "status changes"]]] },
                                { "name": "createdAt", "type": "Date", "sourceReferences": [[["27", "created_at TIMESTAMP"], ["27", "TIMESTAMP DEFAULT"]]] },
                                { "name": "updatedAt", "type": "Date", "sourceReferences": [[["28", "updated_at TIMESTAMP"], ["28", "TIMESTAMP ON"]]] }
                            ]
                        }
                    }
                ],
                "valueObjectActions": [
                    {
                        ...
                        "args": {
                            ...
                            "sourceReferences": [[["7", "and price"], ["7", "price"]]],
                            "properties": [
                                { "name": "amount", "type": "Double", "sourceReferences": [[["25", "price_amount DECIMAL"], ["25", "DECIMAL(10, 2)"]]] },
                                { "name": "currency", "sourceReferences": [[["26", "price_currency VARCHAR"], ["26", "VARCHAR(3)"]]] }
                            ]
                        }
                    }
                ],
                "enumerationActions": [
                    {
                        ...
                        "args": {
                            ...
                            "sourceReferences": [[["4", "status changes"], ["4", "changes (e.g., Draft"]]],
                            "properties": [
                                { "name": "DRAFT", "sourceReferences": [[["7", "'Draft' state"], ["7", "state"]]] },
                                { "name": "PUBLISHED", "sourceReferences": [[["7", "'Publish' the course"], ["7", "the course"]]] },
                                { "name": "ARCHIVED", "sourceReferences": [[["7", "'Archive' it"], ["7", "it"]]] }
                            ]
                        }
                    }
                ]
