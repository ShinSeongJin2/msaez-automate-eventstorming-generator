...
class ValueObjectProcessor:
    ...
    def get_action_applied_es_value(action: Dict[str, Any], user_id: str, project_id: str, 
        ...
        if action.type == "create":
            ValueObjectProcessor._create_value_object(action, user_id, project_id, es_value, callbacks)
        elif action.type == "update":
            ValueObjectProcessor._update_value_object(action, user_id, project_id, es_value, callbacks)
    
    @staticmethod
    def _create_value_object(action: Dict[str, Any], user_id: str, project_id: str, 
                            es_value: Dict[str, Any], callbacks: Dict[str, List]) -> None:
        """ValueObject 생성 액션을 처리합니다"""
        def create_value_object_callback(es_value: Dict[str, Any], user_id: str, project_id: str) -> None:
