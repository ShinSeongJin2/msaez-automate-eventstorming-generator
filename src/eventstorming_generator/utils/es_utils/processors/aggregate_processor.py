...
class AggregateProcessor:
    ...
    def get_action_applied_es_value(action: Dict[str, Any], user_id: str, project_id: str, 
        ...
        if action.type == "create":
            AggregateProcessor._create_aggregate(action, user_id, project_id, es_value, callbacks)
        elif action.type == "update":
            AggregateProcessor._update_aggregate(action, user_id, project_id, es_value, callbacks)
    
    @staticmethod
    def _create_aggregate(action: Dict[str, Any], user_id: str, project_id: str, es_value: Dict[str, Any], 
        ...
        aggregate_object = AggregateProcessor._get_aggregate_base(
            user_id, aggregate_name, aggregate_alias, aggregate_description, bounded_context_id, 0, 0, aggregate_id, refs
        )
    ...
    @staticmethod
    def _update_aggregate(action: Dict[str, Any], user_id: str, project_id: str, 
                          es_value: Dict[str, Any], callbacks: Dict[str, List]) -> None:
    ...
    @staticmethod
    def _get_aggregate_base(user_id: str, name: str, display_name: str, 
