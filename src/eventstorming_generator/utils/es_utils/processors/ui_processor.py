...
class UIProcessor:
    ...
    def get_action_applied_es_value(action: Dict[str, Any], user_id: str, project_id: str, 
        ...
        if action.type == "create":
            UIProcessor._create_ui(action, user_id, project_id, es_value, callbacks)
        elif action.get("type") == "update":
            UIProcessor._update_ui(action, user_id, project_id, es_value, callbacks)
    
    @staticmethod
    def _create_ui(action: Dict[str, Any], user_id: str, project_id: str, 
                   es_value: Dict[str, Any], callbacks: Dict[str, List]) -> None:
        """UI 생성 액션을 처리합니다"""
        ...
        ui_object = UIProcessor._get_ui_base(
            user_id, ui_name, ui_alias, bounded_context_id, 
    ...
    @staticmethod
    def _get_ui_base(user_id: str, name: str, display_name: str,
    ...
    @staticmethod
    def _update_ui(action: Dict[str, Any], user_id: str, project_id: str, 
                   es_value: Dict[str, Any], callbacks: Dict[str, List]) -> None:
        """기존 UI를 업데이트합니다"""
