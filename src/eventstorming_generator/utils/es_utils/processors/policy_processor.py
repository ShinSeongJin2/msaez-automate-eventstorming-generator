...
class PolicyProcessor:
    ...
    def get_action_applied_es_value(action: Dict[str, Any], user_id: str, project_id: str, 
        ...
        if action.get("type") == "create":
            PolicyProcessor._create_policy(action, user_id, project_id, es_value, callbacks)
    
    @staticmethod
    def _create_policy(action: Dict[str, Any], user_id: str, project_id: str, es_value: Dict[str, Any], 
        ...
        policy_object = PolicyProcessor._get_policy_base(
            user_id, policy_name, policy_alias, reason,
    ...
    @staticmethod
    def _get_policy_base(user_id: str, name: str, display_name: str, reason: str,
    ...
    def _make_relations(policy_object: Dict[str, Any], action: Dict[str, Any], callbacks: Dict[str, List]) -> None:
        ...
        def create_relations_callback(es_value_cb: Dict[str, Any], user_id: str, project_id: str) -> None:
            # Input Event -> Policy
