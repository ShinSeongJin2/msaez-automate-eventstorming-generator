...
class EnumerationProcessor:
    ...
    def get_action_applied_es_value(action: Dict[str, Any], user_id: str, project_id: str, 
        ...
        if action.type == "create":
            EnumerationProcessor._create_enumeration(action, user_id, project_id, es_value, callbacks)
        elif action.type == "update":
            EnumerationProcessor._update_enumeration(action, user_id, project_id, es_value, callbacks)
    
    @staticmethod
    def _create_enumeration(action: Dict[str, Any], user_id: str, project_id: str, 
                           es_value: Dict[str, Any], callbacks: Dict[str, List]) -> None:
        """Enumeration 생성 액션을 처리합니다"""
        def create_enumeration_callback(es_value: Dict[str, Any], user_id: str, project_id: str) -> None:
    ...
    @staticmethod
    def _update_enumeration(action: Dict[str, Any], user_id: str, project_id: str, 
                           es_value: Dict[str, Any], callbacks: Dict[str, List]) -> None:
        """Enumeration 업데이트 액션을 처리합니다"""
        def update_enumeration_callback(es_value: Dict[str, Any], user_id: str, project_id: str) -> None:
