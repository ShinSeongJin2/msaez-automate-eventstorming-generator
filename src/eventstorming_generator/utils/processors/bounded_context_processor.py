...
class BoundedContextProcessor:
    @staticmethod
    def get_action_applied_es_value(action: ActionModel, user_info: Dict[str, Any], 
                                   information: Dict[str, Any], es_value: Dict[str, Any], 
                                   callbacks: Dict[str, List]) -> None:
        """액션에 따라 BoundedContext를 처리합니다"""
        if action.type == "create":
            BoundedContextProcessor._create_bounded_context(action, user_info, information, es_value, callbacks)
    
    @staticmethod
    def _create_bounded_context(action: ActionModel, user_info: Dict[str, Any], 
                              information: Dict[str, Any], es_value: Dict[str, Any], 
                              callbacks: Dict[str, List]) -> None:
        ...
        bounded_context_object = BoundedContextProcessor._get_bounded_context_base(
            user_info, information, bc_name, bc_alias, port_number, 
    ...
    @staticmethod
    def _get_bounded_context_base(user_info: Dict[str, Any], information: Dict[str, Any],
        ...
        return {
            ...
            "templatePerElements": {},
            "views": [],
            "definitionId": information.get("projectId", "")
        }
