...
class ResultModel(BaseModelWithItem):
    """Model representing the result containing all actions"""
...
class CreateAggregateActionsByFunctionOutput(BaseModelWithItem):
    ...
    result: ResultModel = Field(..., description="Generated actions for creating aggregates, value objects, and enumerations")
