...
from eventstorming_generator.terminal.commons.graph import execute_create_draft_by_function_sub_graph
from eventstorming_generator.terminal.commons.mocks import create_draft_by_function_sub_graph_inputs
from eventstorming_generator.terminal.terminal_tests.terminal_test_helper import TerminalTestHelper


class TestCreateDraftByFunctionSubGraph:
    """CreateDraftByFunctionSubGraph 테스트"""
    def test_create_draft_by_function_sub_graph(self):
        """CreateDraftByFunctionSubGraph가 올바르게 실행되는지 테스트"""
        ...
        TerminalTestHelper.test_state_by_after_stop_node(
            "create_draft_by_function", create_draft_by_function_sub_graph_inputs, state
        )